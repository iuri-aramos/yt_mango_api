...
describe('Login Router validate parameters', () => {
  ...
  it('should return 500 if httpRequest body is null', async () => {
    // system under test
    const { sut } = makeSut()
...
describe('Login Router Auth Token', () => {
  ...
  it('should return a 200 when valid credentials are provided', async () => {
    // system under test
    const { sut, authUseCaseSpy } = makeSut()
  ...
  it('should return 500 if authUseCase throws an exception', async () => {
